...
use radguy::{
    ...
    ordered::{
        ...
        oracle::{
            ...
            InverseDependentCountOracle, SiblingsOracle, StrategicArgumentsOracle,
...
macro_rules! bisim_bench_problem_ordered {
    ($name:ident: using $c:expr, strategy $s:ty; $sname:literal; $left:expr, $right:expr => $eq:literal in $ccs:expr) => {
        ...
        bisim_bench_oracles_ordered! {
            ...
            StrategicArgumentsOracle::successors().and_by(DependencyCountOracle::default(), std::cmp::min),
            StrategicArgumentsOracle::successors().and_by(InverseDependencyCountOracle::default(), std::cmp::min),
            StrategicArgumentsOracle::ancestors(),
            StrategicArgumentsOracle::ancestors().and_by(DependencyCountOracle::default(), std::cmp::min),
            StrategicArgumentsOracle::ancestors().and_by(InverseDependencyCountOracle::default(), std::cmp::min),
            ...
            StrategicArgumentsOracle::successors().then(DependencyCountOracle::default()),
            StrategicArgumentsOracle::successors().then(InverseDependencyCountOracle::default()),
            StrategicArgumentsOracle::successors().and_by(SMax::default().constant(StrategyWeight::Infinity), std::cmp::min).then(DependencyCountOracle::default()),
            StrategicArgumentsOracle::successors().and_by(SMax::default().constant(StrategyWeight::Infinity), std::cmp::min).then(InverseDependencyCountOracle::default()),
            StrategicArgumentsOracle::successors().then(StrategicHeightOracle::simple()),
            StrategicArgumentsOracle::successors().then(StrategicHeightOracle::transitive()),
            StrategicArgumentsOracle::ancestors().then(DependentCountOracle::default()),
            StrategicArgumentsOracle::ancestors().then(InverseDependencyCountOracle::default()),
            StrategicArgumentsOracle::ancestors().and_by(SMax::default().constant(StrategyWeight::Infinity), std::cmp::min).then(DependencyCountOracle::default()),
            StrategicArgumentsOracle::ancestors().and_by(SMax::default().constant(StrategyWeight::Infinity), std::cmp::min).then(InverseDependencyCountOracle::default()),
            StrategicArgumentsOracle::ancestors().then(StrategicHeightOracle::simple()),
            StrategicArgumentsOracle::ancestors().then(StrategicHeightOracle::transitive()),
