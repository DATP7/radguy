...
test_oracles_ordered_numerical! {
    ...
    SMax::bitset().ordered().and_by(DependencyCountOracle::default(), std::cmp::min), smax_ord_and_min_count_bitset;
    ...
    SMax::hashset().ordered().and_by(DependencyCountOracle::default(), std::cmp::min), smax_ord_and_min_count_hashset;
